...
// or inside an orphan folder.
func CheckPath(vars []platform.PathVar, results []model.Result) []model.PathIssue {
	...
	for _, v := range vars {
		...
		case err != nil || !st.IsDir():
			issue.Problem, issue.Details = "missing folder", platform.PathNote(full)
